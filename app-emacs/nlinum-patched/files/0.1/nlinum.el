...
(defun nlinum-face-function (line)
  'linum-dark)

(defun nlinum-format-function (line)
  (format "%%%dd" nlinum--width))
  ...
  (save-excursion
    ...
    (let ((inhibit-point-motion-hooks t))
      ...
      (let ((line (nlinum--line-number-at-pos)))
        (let ((fmt (nlinum-format-function line)))
          (while
                 ...
                 (let* ((ol (make-overlay (point) (1+ (point))))
                   ...
                   (overlay-put ol 'before-string
                                (propertize " " 'display
                                            `((margin left-margin)
                                              ,(propertize str
                                                           'face (nlinum-face-function line)))))
